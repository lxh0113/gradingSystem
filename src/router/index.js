...
import Mistakes from "@/views/mistakes/index.vue"
            ...
            children: [
              {
                ...
                children: [
                  {
                    path: "on",
                    name: "studentHomePaperOn",
                    component: StudentHomePaperOn,
                  },
                  {
                    path: "off",
                    name: "studentHomePaperOff",
                    component: StudentHomePaperOff,
                  },
                ],
              },
              {
                ...
                children: [
                  {
                    path: "on",
                    name: "studentPapersOn",
                    component: StudentPapersOn,
                  },
                  {
                    path: "off",
                    name: "studentPapersOff",
                    component: StudentPapersOff,
                  },
                  {
                    path: "mistakes",
                    name: "studentPapersMistakes",
                    component: StudentPapersMistakes,
                  },
                  {
                    path: "notes",
                    ...
                    children: [
                      {
                        path: ":id",
                        name: "studentPapersNotesDetails",
                        component: StudentPapersNotesDetails,
                      },
                    ],
                  },
                ],
        ...
        children: [
          {
            ...
            children: [
                ...
                children: [
                  {
                    ...
                    component: () =>
                      import(
                        "@/views/parents/home/components/parentsHomeOn.vue"
                      ),
                  },
                  {
                    path: "off",
                    ...
                    component: () =>
                      import(
                        "@/views/parents/home/components/parentsHomeOff.vue"
                      ),
                  },
                ],
              },
                ...
                children: [
                  {
                    ...
                    name: "parentsPapers",
                    component: () =>
                      import("@/views/parents/childrenPapers/index.vue"),
                    redirect: (to) => {
                      // 重定向到on页面，并将路由参数id传递给子路由
                      return {
                        name: "parentsPapersOff",
                    ...
                    children: [
                      {
                        ...
                        component: () =>
                          import(
                            "@/views/parents/childrenPapers/components/parentsChildrenPapersOff.vue"
                          ),
                      },
                      {
                        path: "on",
                        name: "parentsPapersOn",
                        component: () =>
                          import(
                            "@/views/parents/childrenPapers/components/parentsChildrenPapersOn.vue"
                          ),
                      },
                    ],
                  },
              ...
              {
                path: "analysis",
                name: "parentsAnalysis",
                component: () =>
                  import("@/views/parents/studyAnalysis/index.vue"),
              },
              {
                path: "relationship",
                name: "parentsRelationship",
                component: () =>
                  import("@/views/parents/relationship/index.vue"),
              },
            ],
          },
        ],
            ...
            children: [
                ...
                children: [
                  {
                    ...
                    component: () =>
                      import(
                        "@/views/teacher/home/components/teacherHomeOn.vue"
                      ),
                  },
                  {
                    path: "off",
                    ...
                    component: () =>
                      import(
                        "@/views/teacher/home/components/teacherHomeOff.vue"
                      ),
                  },
                ],
              },
              {
                ...
                children: [
                  {
                    path: "all",
                    name: "teacherMarkingAll",
                    component: () =>
                      import(
                        "@/views/teacher/marking/components/teacherMarkingAll.vue"
                      ),
                  },
                  {
                    path: "on",
                    name: "teacherMarkingOn",
                    component: () =>
                      import(
                        "@/views/teacher/marking/components/teacherMarkingOn.vue"
                      ),
                  },
                  {
                    path: "off",
                    name: "teacherMarkingOff",
                    component: () =>
                      import(
                        "@/views/teacher/marking/components/teacherMarkingOff.vue"
                      ),
                  },
                  {
                    path: ":id",
                    ...
                    component: () =>
                      import(
                        "@/views/teacher/marking/components/teacherMarkingDetails.vue"
                      ),
                  },
                ],
              },
              {
                ...
                children: [
                  {
                    path: "generate",
                    name: "teacherAiGenerate",
                    component: TeacherAiGenerate,
                  },
                ],
              },
              {
                ...
                component: () =>
                  import("@/views/teacher/examAnalysis/index.vue"),
              },
              {
                path: "management/:classId",
                name: "teacherManagement",
                component: () =>
                  import("@/views/teacher/classManagement/index.vue"),
                children: [
                  {
                    path: ":studentId",
                    ...
                    component: () =>
                      import(
                        "@/views/teacher/classManagement/components/TeacherViewStudent.vue"
                      ),
                  },
                ],
              },
            ...
            children: [
              {
                ...
                children: [
                  {
                    path: "on",
                    name: "schoolAdminHomeOn",
                    component: () =>
                      import(
                        "@/views/schoolAdmin/home/components/schoolAdminHomeOn.vue"
                      ),
                  },
                  {
                    path: "off",
                    name: "schoolAdminHomeOff",
                    component: () =>
                      import(
                        "@/views/schoolAdmin/home/components/schoolAdminHomeOff.vue"
                      ),
                  },
                  {
                    path: "will",
                    name: "schoolAdminHomeWill",
                    component: () =>
                      import(
                        "@/views/schoolAdmin/home/components/schoolAdminHomeWill.vue"
                      ),
                  },
                ],
              },
              {
                ...
                component: () =>
                  import("@/views/schoolAdmin/peopleManagement/index.vue"),
                redirect: "/schoolAdmin/management/student",
                children: [
                  {
                    path: "student",
                    name: "schoolAdminPeopleManagementStudent",
                    component: () =>
                      import(
                        "@/views/schoolAdmin/peopleManagement/components/schoolAdminPeopleManagementStudent.vue"
                      ),
                  },
                  {
                    path: "teacher",
                    name: "schoolAdminPeopleManagementTeacher",
                    component: () =>
                      import(
                        "@/views/schoolAdmin/peopleManagement/components/schoolAdminPeopleManagementTeacher.vue"
                      ),
                  },
                ],
              },
              {
                path: "analysis",
                name: "schoolAdminAnalysis",
                component: () =>
                  import("@/views/schoolAdmin/examAnalysis/index.vue"),
              },
              {
                path: "papers",
                name: "schoolAdminPapers",
                component: () =>
                  import("@/views/schoolAdmin/papersManagement/index.vue"),
              },
              {
                path: "papers/:id",
                name: "schoolAdminPaperDetails",
                component: () =>
                  import(
                    "@/views/schoolAdmin/papersManagement/components/schoolAdminPaperDetails.vue"
                  ),
              },
            ],
          },
            ...
            children: [
              {
                ...
                children: [
                  {
                    path: "all",
                    name: "adminAccountAuditAll",
                    component: () =>
                      import(
                        "@/views/admin/accountAudit/components/adminAccountAuditAll.vue"
                      ),
                  },
                  {
                    path: "underway",
                    name: "adminAccountAuditUnderway",
                    component: () =>
                      import(
                        "@/views/admin/accountAudit/components/adminAccountAuditUnderway.vue"
                      ),
                  },
                  {
                    path: "examine",
                    name: "adminAccountAuditExamine",
                    component: () =>
                      import(
                        "@/views/admin/accountAudit/components/adminAccountAuditExamine.vue"
                      ),
                  },
                ],
              },
              {
                ...
                component: () =>
                  import("@/views/admin/accountManagement/index.vue"),
                redirect: "/admin/accountManagement/all",
                children: [
                  {
                    path: "all",
                    name: "adminAccountManagementAll",
                    component: () =>
                      import(
                        "@/views/admin/accountManagement/components/adminAccountManagementAll.vue"
                      ),
                  },
                  {
                    path: "underway",
                    name: "adminAccountManagementUnderway",
                    component: () =>
                      import(
                        "@/views/admin/accountManagement/components/adminAccountManagementUnderway.vue"
                      ),
                  },
                  {
                    path: "examine",
                    name: "adminAccountManagementExamine",
                    component: () =>
                      import(
                        "@/views/admin/accountManagement/components/adminAccountManagementExamine.vue"
                      ),
                  },
                ],
              },
